...
public interface ISerializationService
{
    ...
    Ex<string> Serialize<T>(T dataToSerialize, IJsonTypeInfoResolver? serializerContext);
    ...
    Ex<T> Deserialize<T>(Ex<string> data, IJsonTypeInfoResolver? serializerContext);
    ...
    /// <param name="serializerContext">Optional, a serializer context generated by Json Source Generator.</param>
    Ex<bool> SerializeToFile<T>(T dataToSerialize, Ex<FileName> fileName, IJsonTypeInfoResolver? serializerContext);
    ...
    Ex<T> DeserializeFromFile<T>(Ex<FileName> fileName, IJsonTypeInfoResolver? serializerContext);
